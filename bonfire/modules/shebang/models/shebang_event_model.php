<?php
    class Shebang_event_model extends BF_Model{
        ...
        /**
         * Name of the relation table shebang - event N to N
         *
         * @access protected
         *
         * @var string
         */
        protected $relation = 'shebang_vs_events';
        ...
        protected $field_info = array(
            array('name' => 'id_event', 'primary_key' => 1),
        ...
        public function insert($data=array())
        {
            ...
            $shebangId = decode_key($data['paramsId'],$this->config->config['encryption_key']);
            unset($data['paramsId']);
            ...
            if(isset($id) && $id > 0 ){
                if ( ! class_exists('Shebang_vs_event'))
                {
                    $this->load->model('shebang_vs_event');
                }

                $this->shebang_vs_event->insert($id,$shebangId);
